...
In this module we will go over the two main things.
- **Basics of using codio:**
  - Opening the codio terminal.
...
- Introduces you to the Codio workflow.
- You will identify and use essential tools like the code editor, file tree, and terminal.

### 2. **Interactive Python, and Basics**
